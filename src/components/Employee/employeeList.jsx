import { Tooltip, Table, TableHeader, Modal, ModalContent, Button, ModalFooter, ModalHeader, ModalBody, useDisclosure, TableColumn, TableBody, TableRow, TableCell,User } from "@nextui-org/react";
...
export default function EmployeeTable() {
    ...
    useEffect(() => {
        const getEmployee = async () => {
            await apiInstance.get(`users`, { params: { limit: 80 } })
                .then(res => {
